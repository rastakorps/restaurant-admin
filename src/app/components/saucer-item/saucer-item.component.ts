...
export class SaucerItemComponent implements OnInit {
  ...
  @Output() showSaucer = new EventEmitter();
  ...
  constructor(public alertController: AlertController, public modalCtrl: ModalController, public _DomSanitizationService: DomSanitizer) { }
  ...
  onShowSaucer(saucerId: Number) {
    this.showSaucer.emit(saucerId);
  }
